            ...
            if ($obsFestival['name'] === $parentEnglishName) {
                ...
                if ($holiDate->year === $festivalYear) {
                    ...
                    $holiFestival = [
                        ...
                        'observance_note' => Localization::translate('String', 'observance_note_day_after') !== 'observance_note_day_after'
                            ? sprintf(Localization::translate('String', 'observance_note_day_after'), $daysAfter, $parentEnglishName)
                            : 'Observed ' . $daysAfter . ' day(s) after ' . $parentEnglishName,
                    ];
