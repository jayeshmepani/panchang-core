...
- current generated output reporting 334 unique festival identities and 126 unique vrat identities
...
Current generated vrat coverage includes the generic monthly `Vratni Purnima`
identity in addition to named Purnima vrat identities. Family-based vrat
resolution also keeps named Sankashti, Pradosh, Ekadashi, Masik Shivaratri, and
Masik Krishna Janmashtami observances tied to their parent rule families rather
than treating each display name as a separate rule system.

## Calendar Period Windows

Generated `today`, `month`, and `raw` outputs expose
`calendar_period_windows`, including:

- sidereal ayana windows
- sidereal ritu windows
- Sayana ayana windows
- Sayana ritu windows
- Vikram, Gujarati, Saka, and Kali samvat windows
- samvatsara windows
...
It covers the full daily panchanga, location-aware astronomical timings, both amanta and purnimanta Hindu calendar layers, sidereal and Sayana calendar-period windows, a deep set of muhurta and karmakala windows, special-yoga and vaasa/direction checks, electional screening logic, a large yearly festival and vrata engine whose current generated output reports 334 unique festival identities and 126 unique vrat identities, multi-day festival family handling, and solar/lunar eclipse output with sutak support.
