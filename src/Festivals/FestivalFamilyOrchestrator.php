...
class FestivalFamilyOrchestrator
{
    ...
    public const FESTIVAL_FAMILIES = [
        ...
        'pitru_paksha' => [
            ...
            // These offsets are display-order metadata only. Executable Mahalaya
            // nirnaya is tithi/Aparahna based in Shraddha\ShannavatiResolver;
            // fixed civil-day offsets are invalid in tithi-vriddhi/kshaya cases.
            'offsets_are_nominal' => true,
            'sequence' => [
                ['name' => 'Pratipada Shraddha', 'offset' => 0, 'rule_key' => 'pitru_pratipada', 'time_of_day' => 'aparahna'],
                ['name' => 'Dwitiya Shraddha', 'offset' => 1, 'rule_key' => 'pitru_dwitiya', 'time_of_day' => 'aparahna'],
                ['name' => 'Tritiya Shraddha', 'offset' => 2, 'rule_key' => 'pitru_tritiya', 'time_of_day' => 'aparahna'],
                ['name' => 'Chaturthi Shraddha', 'offset' => 3, 'rule_key' => 'pitru_chaturthi', 'time_of_day' => 'aparahna'],
                ['name' => 'Panchami Shraddha', 'offset' => 4, 'rule_key' => 'pitru_panchami', 'time_of_day' => 'aparahna'],
                ['name' => 'Shashthi Shraddha', 'offset' => 5, 'rule_key' => 'pitru_shashthi', 'time_of_day' => 'aparahna'],
                ['name' => 'Saptami Shraddha', 'offset' => 6, 'rule_key' => 'pitru_saptami', 'time_of_day' => 'aparahna'],
                ['name' => 'Ashtami Shraddha', 'offset' => 7, 'rule_key' => 'pitru_ashtami', 'time_of_day' => 'aparahna'],
                ['name' => 'Navami Shraddha', 'offset' => 8, 'rule_key' => 'pitru_navami', 'time_of_day' => 'aparahna'],
                ['name' => 'Dashami Shraddha', 'offset' => 9, 'rule_key' => 'pitru_dashami', 'time_of_day' => 'aparahna'],
                ['name' => 'Ekadashi Shraddha', 'offset' => 10, 'rule_key' => 'pitru_ekadashi', 'time_of_day' => 'aparahna'],
                ['name' => 'Dwadashi Shraddha', 'offset' => 11, 'rule_key' => 'pitru_dwadashi', 'time_of_day' => 'aparahna'],
                ['name' => 'Trayodashi Shraddha', 'offset' => 12, 'rule_key' => 'pitru_trayodashi', 'time_of_day' => 'aparahna'],
                ['name' => 'Chaturdashi Shraddha', 'offset' => 13, 'rule_key' => 'pitru_chaturdashi', 'time_of_day' => 'aparahna'],
                ['name' => 'Sarva Pitru Amavasya', 'offset' => 14, 'rule_key' => 'sarva_pitru_amavasya', 'time_of_day' => 'aparahna'],
            ],
    ...
    public const EXCEPTION_LOGIC = [
        ...
        'pitru_paksha_sequence' => [
            'description' => 'Mahalaya Ṣaṇṇavati sequence is Bhadrapada Krishna Pratipada through Amavasya; executable selection is tithi/Aparahna based, not fixed-date offsets.',
            'logic' => 'shannavati_mahalaya_tithi_aparahna',
        ],
        'chhath_sequence' => [
