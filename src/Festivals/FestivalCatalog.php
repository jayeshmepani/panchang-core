...
/**
 * Festival / vrat catalog registry (data + catalog counters only).
 *
 * Structure-only extraction from FestivalService. Rule definitions and algorithms
 * are unchanged; resolution behavior is identical.
 *
 * @see docs/FESTIVAL_REFACTOR_PARITY_CONTRACT.md
 */
final class FestivalCatalog
{
    public const array TITHI_VRATAS = [
        1 => [
        ...
        'Pratipada Shraddha' => [
            ...
            'aliases' => ['Mahalaya Pratipada Shraddha', 'Pitru Paksha Pratipada Shraddha'],
            'description' => 'Pitru Paksha / Mahalaya Shraddha on Krishna Pratipada.',
            'deity' => 'Pitrus',
        ...
        'Dwitiya Shraddha' => [
            ...
            'month_amanta' => 'Bhadrapada',
            'month_purnimanta' => 'Ashvina',
            'aliases' => ['Mahalaya Dwitiya Shraddha', 'Pitru Paksha Dwitiya Shraddha'],
            'description' => 'Pitru Paksha / Mahalaya Shraddha on Krishna Dwitiya.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'strict_karmakala' => true,
            'kshaya_preference' => 'merged_host_day',
        ...
        'Tritiya Shraddha' => [
            ...
            'month_amanta' => 'Bhadrapada',
            'month_purnimanta' => 'Ashvina',
            'aliases' => ['Mahalaya Tritiya Shraddha', 'Pitru Paksha Tritiya Shraddha'],
            'description' => 'Pitru Paksha / Mahalaya Shraddha on Krishna Tritiya.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'strict_karmakala' => true,
            'kshaya_preference' => 'merged_host_day',
        ...
        'Chaturthi Shraddha' => [
            ...
            'month_amanta' => 'Bhadrapada',
            'month_purnimanta' => 'Ashvina',
            'aliases' => ['Mahalaya Chaturthi Shraddha', 'Pitru Paksha Chaturthi Shraddha'],
            'description' => 'Pitru Paksha / Mahalaya Shraddha on Krishna Chaturthi.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'strict_karmakala' => true,
            'kshaya_preference' => 'merged_host_day',
        ...
        'Panchami Shraddha' => [
            ...
            'month_amanta' => 'Bhadrapada',
            'month_purnimanta' => 'Ashvina',
            'aliases' => ['Mahalaya Panchami Shraddha', 'Pitru Paksha Panchami Shraddha'],
            'description' => 'Pitru Paksha / Mahalaya Shraddha on Krishna Panchami.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'strict_karmakala' => true,
            'kshaya_preference' => 'merged_host_day',
        ...
        'Dashami Shraddha' => [
            ...
            'month_amanta' => 'Bhadrapada',
            'month_purnimanta' => 'Ashvina',
            'aliases' => ['Mahalaya Dashami Shraddha', 'Pitru Paksha Dashami Shraddha'],
            'description' => 'Pitru Paksha / Mahalaya Shraddha on Krishna Dashami.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'strict_karmakala' => true,
            'kshaya_preference' => 'merged_host_day',
        ...
        'Ekadashi Shraddha' => [
            ...
            'month_amanta' => 'Bhadrapada',
            'month_purnimanta' => 'Ashvina',
            'aliases' => ['Mahalaya Ekadashi Shraddha', 'Pitru Paksha Ekadashi Shraddha'],
            'description' => 'Pitru Paksha / Mahalaya Shraddha on Krishna Ekadashi.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'strict_karmakala' => true,
            'kshaya_preference' => 'merged_host_day',
        ...
        'Dwadashi Shraddha' => [
            ...
            'month_amanta' => 'Bhadrapada',
            'month_purnimanta' => 'Ashvina',
            'aliases' => ['Mahalaya Dwadashi Shraddha', 'Pitru Paksha Dwadashi Shraddha'],
            'description' => 'Pitru Paksha / Mahalaya Shraddha on Krishna Dwadashi.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'strict_karmakala' => true,
            'kshaya_preference' => 'merged_host_day',
        ...
        'Trayodashi Shraddha' => [
            ...
            'month_amanta' => 'Bhadrapada',
            'month_purnimanta' => 'Ashvina',
            'aliases' => ['Mahalaya Trayodashi Shraddha', 'Pitru Paksha Trayodashi Shraddha'],
            'description' => 'Pitru Paksha / Mahalaya Shraddha on Krishna Trayodashi.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'strict_karmakala' => true,
            'kshaya_preference' => 'merged_host_day',
    ...
    public const array FESTIVALS = [
        ...
        'Lohri' => [
            ...
            'parent_festival' => 'Makara Sankranti (Pongal)',
            'days_after' => -1,
            'description' => 'Punjabi harvest festival; bonfire celebration on the eve of Makara Sankranti',
            'deity' => 'Agni/Surya',
        ...
        'Cheti Chand' => [
            ...
            'paksha' => 'Shukla',
            'tithi' => 2,
            // Sindhi New Year is Chaitra Shukla Dwitiya under both calendars.
            // Do not allow Phalguna under purnimanta — that creates false early/late hits.
        ...
        'Vinayaka Chaturthi' => [
            ...
            'month_amanta' => 'Bhadrapada',
            'month_purnimanta' => 'Bhadrapada',
            'aliases' => ['Ganesh Chaturthi', 'Siddhivinayaka Chaturthi'],
        ...
        'Ashvina Sharad Navaratri Day 8 (Mahagauri Puja)' => [
            'type' => 'tithi',
            'resolver' => 'classical',
            'paksha' => 'Shukla',
            'tithi' => 8,
        ...
        'Ashvina Sharad Navaratri Day 9 (Siddhidatri Puja)' => [
            'type' => 'tithi',
            'resolver' => 'classical',
            'paksha' => 'Shukla',
            'tithi' => 9,
        ...
        'Akshaya Tritiya' => [
            ...
            'month_amanta' => 'Vaishakha',
            'month_purnimanta' => 'Vaishakha',
            // DOC festival identity is Treta Yuga Diwas with Akshaya Tritiya as alias.
            'identity_key' => 'Treta Yuga Diwas',
            'display_name' => 'Akshaya Tritiya',
            'aliases' => ['Akshaya Tritiya', 'Akshaya Tritiya (Lakshmi-Narayana)', 'Treta Yuga Diwas'],
        ...
        'Vat Purnima' => [
            ...
            'month_amanta' => 'Jyeshtha',
            'month_purnimanta' => 'Jyeshtha',
            // DOC vrat identity is Jyeshtha Purnima (Vat Purnima is alias).
            'identity_key' => 'Jyeshtha Purnima',
            'display_name' => 'Vat Purnima',
            'aliases' => ['Vat Purnima', 'Vat Savitri Purnima'],
        ...
        'Vaishakha Amavasya' => [
            ...
            'month_amanta' => 'Vaishakha',
            'month_purnimanta' => 'Jyeshtha',
            'description' => 'Amavasya falling on Amanta Vaishakha / Purnimanta Jyeshtha',
            'deity' => 'Pitrus',
            'karmakala_type' => 'sunrise',
            'require_sunrise_vyapini' => true,
            'vriddhi_preference' => 'first',
        ...
        'Vat Savitri Vrat' => [
            ...
            'month_amanta' => 'Vaishakha',
            'month_purnimanta' => 'Jyeshtha',
            'aliases' => ['Vat Savitri Amavasya', 'North Indian Vat Savitri Vrat'],
            'description' => 'Vat Savitri Vrat observed on Jyeshtha Amavasya (Purnimanta) / Vaishakha Amavasya (Amanta) by married women in North India.',
            'deity' => 'Savitri/Brahma/Satyavan',
            'fasting' => true,
            'karmakala_type' => 'sunrise',
            'require_sunrise_vyapini' => true,
            'vriddhi_preference' => 'first',
        ...
        'Shani Jayanti' => [
            ...
            'month_amanta' => 'Vaishakha',
            'month_purnimanta' => 'Jyeshtha',
            'aliases' => ['Shani Dev Jayanti'],
            'description' => 'Birth anniversary of Lord Shani (Saturn) observed on Jyeshtha Amavasya (Purnimanta) / Vaishakha Amavasya (Amanta).',
            'deity' => 'Shani',
            'fasting' => true,
            'karmakala_type' => 'sunrise',
            'require_sunrise_vyapini' => true,
        ...
        'Jyeshtha Amavasya' => [
            ...
            'month_amanta' => 'Jyeshtha',
            'month_purnimanta' => 'Ashadha',
            'description' => 'Amavasya falling in the month of Jyeshtha (Amanta) / Ashadha (Purnimanta)',
            'deity' => 'Pitrus',
            'karmakala_type' => 'sunrise',
            'require_sunrise_vyapini' => true,
            'vriddhi_preference' => 'first',
        ...
        'Bhadrapada Amavasya' => [
            ...
            'month_amanta' => 'Bhadrapada',
            'month_purnimanta' => 'Bhadrapada',
            'aliases' => ['Pithori Amavasya', 'Kushagrahani Amavasya'],
            'description' => 'Amavasya falling in the month of Bhadrapada (Pithori Amavasya / Kushagrahani Amavasya)',
            'deity' => 'Pitrus',
            'karmakala_type' => 'sunrise',
            'require_sunrise_vyapini' => true,
            'vriddhi_preference' => 'first',
        ...
        'Mahalaya Amavasya' => [
            ...
            'month_amanta' => 'Bhadrapada',
            'month_purnimanta' => 'Ashvina',
            'aliases' => ['Sarva Pitru Amavasya', 'Sarvapitra Moksha Amavasya', 'Pitru Amavasya', 'Peddala Amavasya'],
            'description' => 'Mahalaya Amavasya (Sarva Pitru Amavasya) marks the conclusion of Pitru Paksha and the eve of Sharad Navratri.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'darsha_amavasya_aparahna_table' => true,
            'vriddhi_preference' => 'first',
        ...
        'Adhika Chandra Darshana' => [
            ...
            'chandra_darshana_visibility_model' => 'source_sensitive_monthly_chandra_darshana_first_crescent',
            'chandra_darshana_visibility_basis' => 'application_definition_first_visible_crescent',
            'location_sensitive' => true,
        ],
        ...
        'Rohini Vrat' => [
            ...
            'allow_adhika' => true,
            'karmakala_type' => 'sunrise',
            'observe_kshaya_nakshatra_entry_day' => true,
        ],
        ...
        'Ganesh Chaturthi' => [
            ...
            'deity' => 'Ganesha',
            'resolution_alias_of' => 'Vinayaka Chaturthi',
            'karmakala_type' => 'madhyahna',
            'strict_karmakala' => true,
            'require_karmakala_match' => true,
            'previous_tithi_vedha_tolerated' => true,
        ...
        // Classical Avidhava / Saubhagyavati Navami (NOT Labh Panchami's "Saubhagya Panchami").
        // Pitru Paksha Krishna Navami: shraddha for sumangali women who died while their husbands lived.
        // Amanta: Bhadrapada Krishna 9; Purnimanta: Ashvina Krishna 9 (Prokerala / Drik / North Indian usage).
        'Avidhava Navami' => [
            'type' => 'tithi',
            'resolver' => 'classical',
            'paksha' => 'Krishna',
            ...
            'month_purnimanta' => 'Ashvina',
            'aliases' => [
                'Saubhagyavati Navami',
                'Saubhagyavati (Vidhwa) Navami',
                'Navami Shraddha',
                'Matru Navami',
                'Matra Navami',
                'Avidhava Shraddha',
            ...
            'description' => 'Pitru Paksha Avidhava (Saubhagyavati) Navami: ancestral rites for married women (sumangali) who died before their husbands; also the principal Navami Shraddha / Matru Navami of the fortnight',
            'deity' => 'Pitrus',
            'regions' => ['North India', 'Gujarat', 'Maharashtra', 'Karnataka', 'Andhra Pradesh'],
            'karmakala_type' => 'aparahna',
        ],
        'Indira Ekadashi' => [
            'type' => 'tithi',
        ...
        // Kali Chaudas / Deepavali Hanuman Puja (sangava) — distinct from Naraka Chaturdashi Abhyanga Snan (moonrise).
        'Kali Chaudas (Naraka Chaturdashi)' => [
            ...
            'month_amanta' => 'Ashvina',
            'month_purnimanta' => 'Kartika',
            'aliases' => ['Kali Chaudas', 'Hanuman Puja', 'Deepavali Hanuman Puja'],
        ...
        'Govardhan Puja' => [
            ...
            'month_amanta' => 'Kartika',
            'month_purnimanta' => 'Kartika',
            'aliases' => ['Annakut', 'Govardhan Utsav'],
            ...
            'resolution_policy' => [
                ...
                'later_pratipada_full_rites_muhurta_threshold' => 10,
                'previous_viddha_fallback_below_muhurta_threshold' => 9,
                'gross_dwitiya_entry_chandra_warning_muhurta_threshold' => 6,
            ...
            'source_refs' => ['Satsangi Jeevan 4.58.1-14', 'Skanda Purana 2.4.10.59-64', 'Dharma Sindhu Bali Puja Nirnaya'],
        ],
        'Bestu Varas' => [
            'type' => 'tithi',
            'resolver' => 'classical',
        ...
        'Karthigai Deepam' => [
            'nakshatra_only' => true,
            'nakshatra' => 'Krittika',
            'allowed_months_amanta' => ['Kartika', 'Margashirsha'],
            'allowed_months_purnimanta' => ['Kartika', 'Margashirsha'],
        ...
        // Vrat identity (DOC): Kurma Jayanti (Vaishakha Purnima Tradition)
        'Kurma Jayanti (Vaishakha Purnima Tradition)' => [
            ...
            'month_amanta' => 'Vaishakha',
            'month_purnimanta' => 'Vaishakha',
            'aliases' => ['Shri Koorma Jayanti', 'Kurma Avatara Appearance', 'Kurma Jayanti'],
        ...
        // Festival identity (DOC): Kurma Jayanti — Satsangi Pratipada rule (display may say Swaminarayan).
        'Kurma Jayanti' => [
            'type' => 'tithi',
            'resolver' => 'classical',
            ...
            'display_name' => 'Swaminarayan Kurma Jayanti',
        ...
        // Distinct from generic Varaha Jayanti (Bhadrapada Shukla Tritiya).
        // Shravana Shukla Chaturthi — Satsangi Jeevan madhyahna / tritiya-vedha rule.
        ...
        'Bali Pratipada' => [
            ...
            'month_purnimanta' => 'Kartika',
            'aliases' => ['Bali Puja'],
            'description' => 'Worship of King Bali on Kartika Shukla Pratipada',
            'deity' => 'Bali',
            'karmakala_type' => 'sayankala',
            'strict_karmakala' => true,
            'govardhan_annakut_truth_table' => true,
            ...
            'force_amanta_month' => true,
            'resolution_policy' => [
                'kartika_shukla_pratipada' => true,
                'shares_dharma_sindhu_govardhan_gokridana_fallback' => true,
                'later_pratipada_full_rites_muhurta_threshold' => 10,
                'previous_viddha_fallback_below_muhurta_threshold' => 9,
                'gross_dwitiya_entry_chandra_warning_muhurta_threshold' => 6,
            ],
            'source_refs' => ['Skanda Purana 2.4.10.9-14', 'Dharma Sindhu Bali Puja Nirnaya'],
        ],
        'Sata Yuga Diwas' => [
            'type' => 'tithi',
            'resolver' => 'classical',
            ...
            'month_amanta' => 'Kartika',
            'month_purnimanta' => 'Kartika',
            'aliases' => ['Akshaya Navami', 'Kushmanda Navami', 'Satya Yuga Diwas', 'Krita Yuga Diwas', 'Krita Yugadi'],
            'description' => 'Kartika Shukla Navami Yugadi tithi; commonly associated with Krita/Satya Yuga remembrance.',
            'deity' => 'Vishnu',
            'karmakala_type' => 'purvahna',
            'akshaya_navami_purvahna_table' => true,
            'vriddhi_preference' => 'first',
            'kshaya_preference' => 'merged_host_day',
            'source_refs' => ['Dharma Sindhu / Nirnaya Sindhu Yugadi tradition'],
        ],
        'Treta Yuga Diwas' => [
            'type' => 'tithi',
            'resolver' => 'classical',
            ...
            'month_amanta' => 'Vaishakha',
            'month_purnimanta' => 'Vaishakha',
            'aliases' => ['Akshaya Tritiya', 'Treta Yugadi'],
            'description' => 'Vaishakha Shukla Tritiya Yugadi tithi, traditionally associated with Treta Yuga remembrance.',
            'deity' => 'Vishnu/Parashurama',
            'karmakala_type' => 'purvahna',
            'akshaya_tritiya_purvahna_table' => true,
            'vriddhi_preference' => 'first',
            ...
            'source_refs' => ['Dharma Sindhu / Nirnaya Sindhu'],
        ],
        'Dwapara Yuga Diwas' => [
            'type' => 'tithi',
            'resolver' => 'classical',
            ...
            'month_amanta' => 'Magha',
            'month_purnimanta' => 'Phalguna',
            'aliases' => ['Dvapara Yuga Diwas', 'Dvapara Yugadi', 'Mauni Amavasya'],
            'description' => 'Magha Krishna Amavasya Yugadi tithi under the selected tradition profile.',
            'deity' => 'Vishnu',
            'karmakala_type' => 'aparahna',
            'darsha_amavasya_aparahna_table' => true,
            'vriddhi_preference' => 'first',
            'kshaya_preference' => 'merged_host_day',
            'source_refs' => ['Dharma Sindhu / later nibandha Yugadi tradition'],
        ],
        'Kali Yuga Diwas' => [
            'type' => 'tithi',
            'resolver' => 'classical',
            ...
            'month_purnimanta' => 'Ashvina',
            'aliases' => ['Kali Yugadi'],
            'description' => 'Bhadrapada Krishna Trayodashi Yugadi tithi under the selected tradition profile.',
            'deity' => 'Shiva/Vishnu',
            'karmakala_type' => 'aparahna',
            'strict_karmakala' => true,
        ...
        // Named Manvadi presentation. The first-class Ṣaṇṇavati resolver separately
        // preserves the exact Dharma-sindhu tithi enumeration as a source profile.
        'Swayambhuva Manvadi' => [
            'type' => 'tithi',
            'resolver' => 'classical',
            'paksha' => 'Shukla',
            ...
            'month_amanta' => 'Chaitra',
            'month_purnimanta' => 'Chaitra',
            'aliases' => ['Swayambhu Manuadi'],
            'description' => 'Chaitra Shukla Tritiya Manvadi.',
            'deity' => 'Brahma/Vishnu',
            'karmakala_type' => 'purvahna',
            'strict_karmakala' => true,
            'allow_adhika' => true,
        ...
        'Swarochisha Manvadi' => [
            ...
            'month_amanta' => 'Chaitra',
            'month_purnimanta' => 'Chaitra',
            'aliases' => ['Svarochisha Manvadi', 'Swarochisha Manuadi'],
            'description' => 'Chaitra Shukla Purnima Manvadi.',
            'deity' => 'Brahma/Vishnu',
            'karmakala_type' => 'purvahna',
            'strict_karmakala' => true,
            'allow_adhika' => true,
        ...
        'Vaivaswata Manvadi' => [
            ...
            'month_amanta' => 'Jyeshtha',
            'month_purnimanta' => 'Jyeshtha',
            'aliases' => ['Vaivasvata Manvadi', 'Vaivaswata Manuadi'],
            'description' => 'Jyeshtha Shukla Purnima Manvadi.',
            'deity' => 'Brahma/Vishnu',
            'karmakala_type' => 'purvahna',
            'strict_karmakala' => true,
            'allow_adhika' => true,
        ...
        'Raivata Manvadi' => [
            ...
            'month_amanta' => 'Ashadha',
            'month_purnimanta' => 'Ashadha',
            'description' => 'Ashadha Shukla Dashami Manvadi.',
            'deity' => 'Brahma/Vishnu',
            'karmakala_type' => 'purvahna',
            'strict_karmakala' => true,
            'allow_adhika' => true,
        ...
        'Chakshusha Manvadi' => [
            ...
            'month_amanta' => 'Ashadha',
            'month_purnimanta' => 'Ashadha',
            'aliases' => ['Cakshusha Manvadi'],
            'description' => 'Ashadha Shukla Purnima Manvadi.',
            'deity' => 'Brahma/Vishnu',
            'karmakala_type' => 'purvahna',
            'strict_karmakala' => true,
            'allow_adhika' => true,
        ...
        'Indra Savarni Manvadi' => [
            ...
            'month_amanta' => 'Shravana',
            'month_purnimanta' => 'Bhadrapada',
            'aliases' => ['Indra Savarni Manuadi', 'Bhadrapada Krishna Ashtami Manvadi'],
            'description' => 'Shravana Krishna / Purnimanta Bhadrapada Krishna Ashtami Manvadi.',
            'deity' => 'Brahma/Vishnu',
            'karmakala_type' => 'aparahna',
            'strict_karmakala' => true,
            'allow_adhika' => true,
        ...
        'Daiva Savarni Manvadi' => [
            ...
            'month_amanta' => 'Shravana',
            'month_purnimanta' => 'Bhadrapada',
            'aliases' => ['Deva Savarni Manvadi', 'Daiva Savarni Manuadi'],
            'description' => 'Common modern named-Manvadi mapping for Shravana Amavasya / Purnimanta Bhadrapada Amavasya.',
            'deity' => 'Brahma/Vishnu',
            'karmakala_type' => 'aparahna',
            'darsha_amavasya_aparahna_table' => true,
            'allow_adhika' => true,
        ...
        'Rudra Savarni Manvadi' => [
            ...
            'month_amanta' => 'Bhadrapada',
            'month_purnimanta' => 'Bhadrapada',
            'description' => 'Bhadrapada Shukla Tritiya Manvadi.',
            'deity' => 'Brahma/Vishnu',
            'karmakala_type' => 'purvahna',
            'strict_karmakala' => true,
            'allow_adhika' => true,
        ...
        'Daksha Savarni Manvadi' => [
            ...
            'month_amanta' => 'Ashvina',
            'month_purnimanta' => 'Ashvina',
            'description' => 'Ashvina Shukla Navami Manvadi.',
            'deity' => 'Brahma/Vishnu',
            'karmakala_type' => 'purvahna',
            'strict_karmakala' => true,
            'allow_adhika' => true,
        ...
        'Tamasa Manvadi' => [
            ...
            'month_amanta' => 'Kartika',
            'month_purnimanta' => 'Kartika',
            'description' => 'Kartika Shukla Dwadashi Manvadi.',
            'deity' => 'Brahma/Vishnu',
            'karmakala_type' => 'purvahna',
            'strict_karmakala' => true,
            'allow_adhika' => true,
        ...
        'Uttama Manvadi' => [
            ...
            'month_amanta' => 'Kartika',
            'month_purnimanta' => 'Kartika',
            'aliases' => ['Auttama Manvadi'],
            'description' => 'Kartika Shukla Purnima Manvadi.',
            'deity' => 'Brahma/Vishnu',
            'karmakala_type' => 'purvahna',
            'strict_karmakala' => true,
            'allow_adhika' => true,
        ...
        'Dharma Savarni Manvadi' => [
            ...
            'month_amanta' => 'Pausha',
            'month_purnimanta' => 'Pausha',
            'description' => 'Pausha Shukla Ekadashi Manvadi.',
            'deity' => 'Brahma/Vishnu',
            'karmakala_type' => 'purvahna',
            'strict_karmakala' => true,
            'allow_adhika' => true,
        ...
        'Brahma Savarni Manvadi' => [
            ...
            'month_amanta' => 'Magha',
            'month_purnimanta' => 'Magha',
            'description' => 'Magha Shukla Saptami Manvadi.',
            'deity' => 'Brahma/Vishnu',
            'karmakala_type' => 'purvahna',
            'strict_karmakala' => true,
            'allow_adhika' => true,
        ...
        'Savarni Manvadi' => [
            ...
            'month_amanta' => 'Phalguna',
            'month_purnimanta' => 'Phalguna',
            'description' => 'Phalguna Shukla Purnima Manvadi.',
            'deity' => 'Brahma/Vishnu',
            'karmakala_type' => 'purvahna',
            'strict_karmakala' => true,
            'allow_adhika' => true,
        ...
        'Bhadrapada Purvedyu Shraddha' => [
            'type' => 'shannavati_membership',
            'shannavati_id' => 'shannavati.purvedyu.bhadrapada',
            'shannavati_profile' => 'dharma_sindhu',
            'aliases' => ['Bhadrapada Purvedyuh Shraddha', 'Bhadrapada Purvedyu Shraddha'],
            'description' => 'Purvedyu ancestral rite in the Bhadrapada Ashtaka cycle of the Shannavati system.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'source_refs' => ['Dharma Sindhu Shannavati enumeration'],
        ],
        'Bhadrapada Ashtaka Shraddha' => [
            'type' => 'shannavati_membership',
            'shannavati_id' => 'shannavati.ashtaka.bhadrapada',
            'shannavati_profile' => 'dharma_sindhu',
            'aliases' => ['Bhadrapada Ashtaka Shraddha', 'Bhadrapada Astaka Shraddha'],
            'description' => 'Ashtaka ancestral rite in the Bhadrapada Ashtaka cycle of the Shannavati system.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'source_refs' => ['Dharma Sindhu Shannavati enumeration'],
        ],
        'Bhadrapada Anvashtaka Shraddha' => [
            'type' => 'shannavati_membership',
            'shannavati_id' => 'shannavati.anvashtaka.bhadrapada',
            'shannavati_profile' => 'dharma_sindhu',
            'aliases' => ['Bhadrapada Anvashtaka Shraddha', 'Bhadrapada Anvastaka Shraddha'],
            'description' => 'Anvashtaka ancestral rite in the Bhadrapada Ashtaka cycle of the Shannavati system.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'source_refs' => ['Dharma Sindhu Shannavati enumeration'],
        ],
        'Margashirsha Purvedyu Shraddha' => [
            'type' => 'shannavati_membership',
            'shannavati_id' => 'shannavati.purvedyu.margashirsha',
            'shannavati_profile' => 'dharma_sindhu',
            'aliases' => ['Margashirsha Purvedyuh Shraddha', 'Margashirsha Purvedyu Shraddha'],
            'description' => 'Purvedyu ancestral rite in the Margashirsha Ashtaka cycle of the Shannavati system.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'source_refs' => ['Dharma Sindhu Shannavati enumeration'],
        ],
        'Margashirsha Ashtaka Shraddha' => [
            'type' => 'shannavati_membership',
            'shannavati_id' => 'shannavati.ashtaka.margashirsha',
            'shannavati_profile' => 'dharma_sindhu',
            'aliases' => ['Margashirsha Ashtaka Shraddha', 'Margashirsha Astaka Shraddha'],
            'description' => 'Ashtaka ancestral rite in the Margashirsha Ashtaka cycle of the Shannavati system.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'source_refs' => ['Dharma Sindhu Shannavati enumeration'],
        ],
        'Margashirsha Anvashtaka Shraddha' => [
            'type' => 'shannavati_membership',
            'shannavati_id' => 'shannavati.anvashtaka.margashirsha',
            'shannavati_profile' => 'dharma_sindhu',
            'aliases' => ['Margashirsha Anvashtaka Shraddha', 'Margashirsha Anvastaka Shraddha'],
            'description' => 'Anvashtaka ancestral rite in the Margashirsha Ashtaka cycle of the Shannavati system.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'source_refs' => ['Dharma Sindhu Shannavati enumeration'],
        ],
        'Pausha Purvedyu Shraddha' => [
            'type' => 'shannavati_membership',
            'shannavati_id' => 'shannavati.purvedyu.pausha',
            'shannavati_profile' => 'dharma_sindhu',
            'aliases' => ['Pausha Purvedyuh Shraddha', 'Pausha Purvedyu Shraddha'],
            'description' => 'Purvedyu ancestral rite in the Pausha Ashtaka cycle of the Shannavati system.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'source_refs' => ['Dharma Sindhu Shannavati enumeration'],
        ],
        'Pausha Ashtaka Shraddha' => [
            'type' => 'shannavati_membership',
            'shannavati_id' => 'shannavati.ashtaka.pausha',
            'shannavati_profile' => 'dharma_sindhu',
            'aliases' => ['Pausha Ashtaka Shraddha', 'Pausha Astaka Shraddha'],
            'description' => 'Ashtaka ancestral rite in the Pausha Ashtaka cycle of the Shannavati system.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'source_refs' => ['Dharma Sindhu Shannavati enumeration'],
        ],
        'Pausha Anvashtaka Shraddha' => [
            'type' => 'shannavati_membership',
            'shannavati_id' => 'shannavati.anvashtaka.pausha',
            'shannavati_profile' => 'dharma_sindhu',
            'aliases' => ['Pausha Anvashtaka Shraddha', 'Pausha Anvastaka Shraddha'],
            'description' => 'Anvashtaka ancestral rite in the Pausha Ashtaka cycle of the Shannavati system.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'source_refs' => ['Dharma Sindhu Shannavati enumeration'],
        ],
        'Magha Purvedyu Shraddha' => [
            'type' => 'shannavati_membership',
            'shannavati_id' => 'shannavati.purvedyu.magha',
            'shannavati_profile' => 'dharma_sindhu',
            'aliases' => ['Magha Purvedyuh Shraddha', 'Magha Purvedyu Shraddha'],
            'description' => 'Purvedyu ancestral rite in the Magha Ashtaka cycle of the Shannavati system.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'source_refs' => ['Dharma Sindhu Shannavati enumeration'],
        ],
        'Magha Ashtaka Shraddha' => [
            'type' => 'shannavati_membership',
            'shannavati_id' => 'shannavati.ashtaka.magha',
            'shannavati_profile' => 'dharma_sindhu',
            'aliases' => ['Magha Ashtaka Shraddha', 'Magha Astaka Shraddha'],
            'description' => 'Ashtaka ancestral rite in the Magha Ashtaka cycle of the Shannavati system.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'source_refs' => ['Dharma Sindhu Shannavati enumeration'],
        ],
        'Magha Anvashtaka Shraddha' => [
            'type' => 'shannavati_membership',
            'shannavati_id' => 'shannavati.anvashtaka.magha',
            'shannavati_profile' => 'dharma_sindhu',
            'aliases' => ['Magha Anvashtaka Shraddha', 'Magha Anvastaka Shraddha'],
            'description' => 'Anvashtaka ancestral rite in the Magha Ashtaka cycle of the Shannavati system.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'source_refs' => ['Dharma Sindhu Shannavati enumeration'],
        ],
        'Phalguna Purvedyu Shraddha' => [
            'type' => 'shannavati_membership',
            'shannavati_id' => 'shannavati.purvedyu.phalguna',
            'shannavati_profile' => 'dharma_sindhu',
            'aliases' => ['Phalguna Purvedyuh Shraddha', 'Phalguna Purvedyu Shraddha'],
            'description' => 'Purvedyu ancestral rite in the Phalguna Ashtaka cycle of the Shannavati system.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'source_refs' => ['Dharma Sindhu Shannavati enumeration'],
        ],
        'Phalguna Ashtaka Shraddha' => [
            'type' => 'shannavati_membership',
            'shannavati_id' => 'shannavati.ashtaka.phalguna',
            'shannavati_profile' => 'dharma_sindhu',
            'aliases' => ['Phalguna Ashtaka Shraddha', 'Phalguna Astaka Shraddha'],
            'description' => 'Ashtaka ancestral rite in the Phalguna Ashtaka cycle of the Shannavati system.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'source_refs' => ['Dharma Sindhu Shannavati enumeration'],
        ],
        'Phalguna Anvashtaka Shraddha' => [
            'type' => 'shannavati_membership',
            'shannavati_id' => 'shannavati.anvashtaka.phalguna',
            'shannavati_profile' => 'dharma_sindhu',
            'aliases' => ['Phalguna Anvashtaka Shraddha', 'Phalguna Anvastaka Shraddha'],
            'description' => 'Anvashtaka ancestral rite in the Phalguna Ashtaka cycle of the Shannavati system.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'source_refs' => ['Dharma Sindhu Shannavati enumeration'],
        ],
        'Vyatipata Shraddha' => [
            'type' => 'shannavati_membership',
            'shannavati_id_prefix' => 'shannavati.vyatipata.',
            'shannavati_profile' => 'dharma_sindhu',
            'aliases' => ['Vyatipata Tarpana', 'Vyatipata Shannavati Shraddha'],
            'description' => 'Shannavati Shraddha on a qualifying Vyatipata Nitya Yoga occurrence selected by Aparahna vyapti.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'source_refs' => ['Dharma Sindhu Shannavati enumeration'],
        ],
        'Vaidhriti Shraddha' => [
            'type' => 'shannavati_membership',
            'shannavati_id_prefix' => 'shannavati.vaidhriti.',
            'shannavati_profile' => 'dharma_sindhu',
            'aliases' => ['Vaidhrti Shraddha', 'Vaidhriti Tarpana', 'Vaidhriti Shannavati Shraddha'],
            'description' => 'Shannavati Shraddha on a qualifying Vaidhriti Nitya Yoga occurrence selected by Aparahna vyapti.',
            'deity' => 'Pitrus',
            'karmakala_type' => 'aparahna',
            'source_refs' => ['Dharma Sindhu Shannavati enumeration'],
        ],
        ...
        // Margashirsha Shukla Dwadashi after Mokshada Ekadashi. Bhavishya Purana / Gujarati panchangs:
        // Akhand Dwadashi vrat completes broken vows (खंडित व्रत पूर्ण) and is distinct from derived Mahadwadashi.
        // Shares the civil tithi with Matsya Dwadashi but is a separate Vishnu-Lakshmi-Narayana vrat identity.
        'Akhand Dwadashi' => [
            'type' => 'tithi',
            'resolver' => 'classical',
            'paksha' => 'Shukla',
            ...
            'aliases' => [
                'Akhanda Dwadashi',
                'Akhand Dwadashi Vrat',
                'Margashirsha Akhand Dwadashi',
                'Agahan Akhand Dwadashi',
                'Magshar Akhand Dwadashi',
            ],
            'description' => 'Akhand Dwadashi vrat on Margashirsha Shukla Dwadashi (the day after Mokshada Ekadashi): Vishnu / Lakshmi-Narayana worship that completes incomplete or broken vows; milk- and curd-based observance described in Bhavishya Purana tradition',
        ...
        'Thrissur Pooram' => [
            ...
            'regions' => ['Kerala'],
            'karmakala_type' => 'sunrise',
            'observe_nakshatra_start_civil_day' => true,
        ],
        'Attukal Pongal' => [
            'type' => 'attukal_pongal',
            'nakshatra' => 'Purva Phalguni',
        ...
        'Gayatri Japam' => [
            'type' => 'day_after',
            'parent_festival' => 'Yajurveda Upakarma',
            'days_after' => 1,
        ...
        'Masik Karthigai' => [
            ...
            'regions' => ['Tamil Nadu'],
            'karmakala_type' => 'sunrise',
            'observe_nakshatra_entry_civil_date' => true,
            'nakshatra_entry_min_before_sunset_muhurtas' => 1,
        ],
        'Yashoda Jayanti' => [
            'type' => 'tithi',
            'resolver' => 'classical',
        ...
        // Alias-only of Kali Chaudas (sangava). Do not resolve independently with sunrise —
        // that wrongly adds the next civil day (e.g. 2026-11-08) onto the Kali Chaudas identity.
        'Hanuman Puja' => [
            'resolution_alias_of' => 'Kali Chaudas (Naraka Chaturdashi)',
            'type' => 'tithi',
            'resolver' => 'classical',
            'paksha' => 'Krishna',
            'tithi' => 14,
            'month_amanta' => 'Ashvina',
            'month_purnimanta' => 'Kartika',
            'aliases' => ['Hanuman Puja', 'Kali Chaudas', 'Deepavali Hanuman Puja'],
            'description' => 'Worship of Lord Hanuman during Diwali period (resolved with Kali Chaudas)',
            'deity' => 'Hanuman',
            'karmakala_type' => 'sangava',
        ],
        'Kedar Gauri Vrat' => [
    ...
    /**
     * Catalog size of non-vrat festival definitions (FESTIVALS rows without fasting).
     *
     * This is year- and calendar-independent. Entries that do not occur in a given
     * year still count toward total_festivals in generated outputs.
     */
    ...
    /**
     * Catalog size of unique vrat identities the package defines.
     *
     * Built from FESTIVALS rows with fasting=true, applying identity_key collapses
     * and expanding generic Pradosh Vrat into the seven weekday-named identities.
     * Year- and calendar-independent (same total_vrats for every year/system).
     */
    public static function getCatalogVratCount(): int
    {
        ...
        foreach (self::FESTIVALS as $key => $definition) {
            ...
            // Generic family rule expands to weekday-specific identities at emit time.
            if ($key === 'Pradosh Vrat') {
                foreach (
                    [
                        'Ravi Pradosh Vrat',
