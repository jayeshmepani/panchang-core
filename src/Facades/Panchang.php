 ...
 * @method static array getCalendarPeriodWindowsRange(int $fromYear, int $fromMonth, int $toYear, int $toMonth, float $lat, float $lon, string $tz, array $fields = [], float $elevation = 0.0, CalendarType|string $calendarType = \JayeshMepani\PanchangCore\Core\Enums\CalendarType::Amanta)
