 ...
 * Panchang Facade.
 *
 * @method static array getDayDetails(CarbonImmutable $date, float $lat, float $lon, string $tz, float $elevation = 0.0, ?CarbonImmutable $calculationAt = null, array $options = [])
 * @method static array getFestivalSnapshot(CarbonImmutable $date, float $lat, float $lon, string $tz, float $elevation = 0.0)
