    ...
    public function generateFestivals(
        ...
        return [
            'festivals' => [
                ...
                'total_festivals' => FestivalService::getCatalogFestivalCount(),
                'total_vrats' => FestivalService::getCatalogVratCount(),
            ...
            $result[$normalized] = match ($normalized) {
                ...
                'muhurta_evaluation' => array_merge(
                    [
                        'scope' => 'transit_only',
                        'notes' => [
                            Localization::translate('String', 'No natal or person-specific inputs are used.'),
                            Localization::translate('String', 'Evaluation is derived only from current Panchang and transit state for the configured location/time.'),
                        ],
                    ],
    ...
    private function selectFestivalCalendarSections(array $festivalCalendar, array $sections): array
    {
        ...
        foreach ($sections as $section) {
            ...
            $result[$normalized] = match ($normalized) {
                ...
                'festival_day_count' => $festivalCalendar['festival_day_count'],
                'festival_entry_count' => $festivalCalendar['festival_entry_count'],
                // Catalog totals: year-independent; non-occurring definitions still count.
                'total_festivals' => FestivalService::getCatalogFestivalCount(),
                'total_vrats' => FestivalService::getCatalogVratCount(),
